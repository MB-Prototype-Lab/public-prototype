...
const BUDDY_ESF =
{
  ...
  "rows": {
    ...
    "rent": {
      "label": "Rent",
      "row": "rent",
      "_note": "YOUR SHARE, not the whole bill. The spec's copy said 'put in the whole payment, even if you split it with someone' — wrong, and expensively so. The fund covers what this person has to keep paying, and a roommate's half is not that. On a $2,400 flat split two ways, counting the whole rent overstates the monthly figure by $1,200 and a six-month target by $7,200.",
      "say": [
        "Rent is what you pay your landlord each month.",
        "Put in your share only. If you split it with someone, count what comes out of your pocket.",
    ...
    "medical": {
      "label": "Medical",
      "row": "medical",
      "_note": "TWO ANSWERS, because the row is built two ways. Somebody covered through work is priced on a replacement premium — what their own plan would cost once the job stopped. Somebody who already buys their own is priced on ordinary out-of-pocket costs, and for them esfReplacementPremium() is 0. An explanation that does not match the number beside it is worse than none. Resolved by the employerCoverage variant in js/buddy-esf.js.",
      "_voiceNote": "OWNER'S RULING, and it overrides the spec: Buddy states what the figure is built from and stops. He does NOT tell the user the number is high. The spec's copy opened 'This one looks high on purpose' — cut. Calling attention to a cost is a short step from suggesting something be done about it, and the same restraint that keeps him off advice keeps him off commentary. The facts do the work: cover comes through the job, the job stopping ends it, so the row prices the replacement.",
        ...
        "employer": [
          {
            ...
            "say": [
              "Good.",
              "The figure is a mid-level plan priced on the ages in your household.",
    ...
    "carCosts": {
      ...
      "say": [
        ...
        "Insurance is the largest part of it. It does not change with how far you drive."
      ],
      "chips": [
        {
          "id": "noCar",
