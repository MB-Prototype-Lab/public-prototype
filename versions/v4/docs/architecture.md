...
> **Written for v3; inherited verbatim by v3.1 and then by v4.** The contracts
> still hold — v4 is a byte copy of v3.1, which was a byte copy of v3 — but
> every path below spelled `versions/v3/` means *whichever version folder you
> are in*, and §"Repo integration" is a record of how v3 was first wired to the
> gate, not a to-do. Where v4 has already diverged, `versions/v4/CLAUDE.md` is
> the authority and this file is the background.
