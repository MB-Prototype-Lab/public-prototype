# Historical study instructions (superseded)

Do not use old tracking toggles; see docs/publishing.md.

# Running a Useberry study against v4

Operator's guide. The reasoning behind the design is in `docs/app-contracts.md`
...
{ id: "v4", label: "v4 (current)", path: "app/index.html", tracking: true }
```
...
**Start URL:** point tasks at `app/index.html`, not the repo root. The
